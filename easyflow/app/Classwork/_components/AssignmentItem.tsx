...
function AssignmentItem({ title = "Untitled Assignment", due = "No due date", onEditClick }: AssignmentItemProps) {
  return (
    <div className="relative h-32 bg-white p-4 rounded-lg shadow-md hover:bg-gray-100 hover:scale-100 transition-all cursor-pointer flex items-center justify-between">
      {/* Left Content */}
