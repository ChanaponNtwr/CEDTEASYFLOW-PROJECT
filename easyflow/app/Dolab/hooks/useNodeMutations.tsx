  ...
  const addNodeOnSelectedEdge = useCallback((type: string, label: string) => {
      ...
      if (source === target && (sourceNode.type === "while" || sourceNode.type === "for")) {
        ...
        if (type === "if") {
          ...
          edgesToAdd.push(createArrowEdge(ifNode.id, bp.id, { label: "True", sourceHandle: "right", targetHandle: "true", step: true, offset: 80 }));
          edgesToAdd.push(createArrowEdge(ifNode.id, bp.id, { label: "False", sourceHandle: "left", targetHandle: "false", step: true, offset: 80 }));
      ...
      if (isBranchingFromIf) {
          ...
          if (type === "if") {
            ...
            const newEdges = [
              ...
              createArrowEdge(newIf.id, newBp.id, { label: "True", sourceHandle: "right", targetHandle: "true", step: true, offset: 80 }),
              createArrowEdge(newIf.id, newBp.id, { label: "False", sourceHandle: "left", targetHandle: "false", step: true, offset: 80 }),
      ...
      if (type === "if") {
        ...
        newEdgesToAdd.push(
          ...
          createArrowEdge(ifNode.id, bp.id, { label: "True", sourceHandle: "right", targetHandle: "true", step: true, offset: 80 }),
          createArrowEdge(ifNode.id, bp.id, { label: "False", sourceHandle: "left", targetHandle: "false", step: true, offset: 80 }),
